        ...
        <AnimatePresence mode="wait">
          {!selectedGame ? (
            ...
            >
              ...
              <div 
                ref={playerRef}
                className={`relative bg-black rounded-3xl overflow-hidden border border-white/10 shadow-2xl transition-all duration-500 ${isFullScreen ? 'aspect-auto w-full h-full' : 'aspect-video w-full'}`}
              >
                {isFullScreen && (
                  <button
                    onClick={toggleFullScreen}
